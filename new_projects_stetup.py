...
def create_update_req_file():
    try:
        ...
        if os.path.exists('requirements.txt'):
            print("requirements.txt already exists. It will be updated with current dependencies.")
        else:
...
def main():
    ...
    venv_activated = input("Have you activated the virtual environment? (y/n), n will do it y will do nothing: ").lower()
    if venv_activated =="n":
    ...
    install_choice = input("have you imported a requirement file and do you want to install the requirements? (y/n): ").lower()
    if install_choice == "y":
        install_requirements()
        list_installed_packages()
    requirement_choice = input("Do you want to create a requirements.txt file? (y/n): ").lower()
